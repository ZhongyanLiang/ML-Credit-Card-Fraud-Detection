{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "# Compare caes of fraud vs valid \n",
    "fraud= data[data['Class']==1]\n",
    "valid=data[data['Class']==0]\n",
    "#fraud vs valid ratio\n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "## Compare amount details in Fraud vs Valid"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Amount details when it's fraud\n"
     ]
    },
    {
     "data": {
   ...
   "source": [
    "#Print out fradulent trasactions\n",
    "print(\"Amount details when it's fraud\")\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Amount details when it's valid\n"
     ]
    },
    {
     "data": {
   ...
   "source": [
    "#Print out normal transactions\n",
    "print(\"Amount details when it's valid\")\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "### **The model has a high accuracy, however the dataset is highly unbalanced ,the positive class (frauds) account for 0.172% of all transactions. So we will measure the accuracy using the Area Under the Precision-Recall Curve (AUPRC).**"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "This [article](\"https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4349800/\") here discussed \"The Precision-Recall Plot Is More Informative than the ROC Plot When Evaluating Binary Classifiers on Imbalanced Datasets\"."
   ]
  },
  {
   "cell_type": "code",
